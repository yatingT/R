...
setwd("C:/Users/Yatin/Documents/spring2021/stat303") #like setwd('C:/Users/bo/Dropbox/STAT327/327_4/code')
getwd()

setwd("..") #like setwd('..')
getwd(); list.files() #list all files in your working directory

setwd("stat303") #like setwd('code')
getwd(); list.files()
...
source("Day 2_Vector-1.R") #like source('2vector.R')
